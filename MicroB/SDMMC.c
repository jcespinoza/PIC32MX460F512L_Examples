...
** 7/20/06 v1.4 LDJ 
** 7/14/07 v2.0 LDJ 
** 1/08/10 v3.0 LDJ ported on MIkroE PIC32MMB 
** 
*/
#include <p32xxxx.h>
#include "SDMMC.h"
...
// I/O definitions
#define SDWP    _RA7    // Write Protect input
#define SDCD    _RA6    // Card Detect input
#define SDCS    _RG9    // Card Select output
...
//          E_INIT_TIMEOUT  failed to initialize
{
    ...
    SPI2BRG = 1;                // Fpb/(2*(1+1))= 80/4 = 20MHz
