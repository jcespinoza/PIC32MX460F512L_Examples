...
// Serial Flash (SST25) control
#define EE_CS               _LATD1
#define EE_CS_TRIS          _TRISD1
#define SST25_CS_LAT        EE_CS
#define SST25_CS_TRIS       EE_CS_TRIS
#define SST25_SCK_TRIS      _TRISG6  
#define SST25_SDI_TRIS      _TRISG7
#define SST25_SDO_TRIS      _TRISG8

// Accelerometer control
#define ACL_CS              _LATC3
#define ACL_CS_TRIS         _TRISC3
