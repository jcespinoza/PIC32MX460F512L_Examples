...
** 3D geometry engine
**
** 8/03/07 LDJ v2.0 regrouping objects
** 1/05/10 LDJ v3.0 x256
** 2/21/10 LDJ v4.0 vectorZproduct and rotation matrix passed as parameter
*/
...
void initMatrix( tmatrix m, short alpha, short beta, short gamma, int x0, int y0, int z0)
{
...
{ // a and b are vectors defining the poligon plane
    ...
    // create a vector containing c-d
    a0 = c[0]-d[0];
    a1 = c[1]-d[1];
    // create a vector containing e-d
    b0 = e[0]-d[0];
    b1 = e[1]-d[1];
