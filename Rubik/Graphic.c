...
static WORD LUT[ 16] = {
    //0      1          2          3            4        5       6      7           
    BLACK, BRIGHTRED, GREEN, BRIGHTYELLOW, BRIGHTBLUE, BROWN, MAGENTA,  WHITE,
    // 8,           9      A        B      C        D    E    F
    DARKGRAY, BRIGHTRED, GREEN, YELLOW, BLUE, MAGENTA, CYAN, WHITE
    };
...
void gHLine(short x0, short x1, short y)
{   // clipped horizontal line 
    ...
    // xa = leftmost point, xb = rightmost point
    if (x0 > x1) 
    {
        xa = x1; xb = x0;
    }
